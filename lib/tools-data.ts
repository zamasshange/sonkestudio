...
export const tools: Tool[] = [
  ...
  { id: 'merge-pdfs', name: 'Merge PDFs', description: 'Combine multiple PDFs into one', icon: FaFilePdf, iconColor: '#E5322D', iconBg: '#fff1f1', category: 'document', tags: ['pdf', 'merge', 'combine'], trending: true, href: '/tools/pdf', usageCount: 134000 },
  { id: 'split-pdfs', name: 'Split PDFs', description: 'Split PDF into separate files', icon: FaFilePdf, iconColor: '#E5322D', iconBg: '#fff1f1', category: 'document', tags: ['pdf', 'split', 'separate'], href: '/tools/pdf', usageCount: 98000 },
  ...
  { id: 'link-shortener', name: 'Link Shortener', description: 'Shorten long URLs', icon: FaLink, iconColor: '#2563EB', iconBg: '#eff6ff', category: 'everyday', tags: ['link', 'shorten', 'url'], href: '/tools/utility/shorten', usageCount: 145000 },
